                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <a class="btn using-tooltip" href="{{url('admin/group')}}" data-toggle="tooltip" data-placement="top" title="Hủy bỏ thao tác">Hủy bỏ<div class="ripple-container"></div></a>

                                @if (session()->get('permission')->canDelete)

                                <a class="btn btn-danger using-tooltip" href="{{url('admin/group/del/'.$data['info']->id)}}" data-toggle="tooltip" data-placement="top" title="Xóa phần tử này?"><i class="material-icons">close</i>Xóa<div class="ripple-container"></div></a>
