                        ...
                        <div class="col-sm-6">
                                ...
                                <div class="dropdown custom-group" style="display: inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-left">
                                        ...
                                        <li><a href="{{url('admin/rule?limit=10')}}">10</a></li>
                                        <li><a href="{{url('admin/rule?limit=20')}}">20</a></li>
                                        <li><a href="{{url('admin/rule?limit=30')}}">30</a></li>
                                        <li><a href="{{url('admin/rule?limit=40')}}">40</a></li>
                                    </ul>
                                </div>
                                <span>Kết quả</span>
